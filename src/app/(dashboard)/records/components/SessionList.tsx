...
const SessionList: React.FC<SessionListProps> = ({
  ...
  return (
    <div className='flex flex-col justify-center w-full xs:w-1/2 lg:w-1/3 h-full shadow-md rounded-lg overflow-clip'>
        ...
        {sessions.map((session) => (
          <div
            ...
            className={`border-b border-gray-400 w-full p-2 cursor-pointer hover:bg-gray-100 ${
              selectedSession === session.name ? 'bg-gray-300 hover:bg-gray-300' : ''
            }`}
